...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Chocolate Syrup", 0.20, new ArrayList<>(Arrays.asList( "chocolate")));
        Topping topping2 = new Topping("Caramel Syrup", 0.20, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping3 = new Topping("Whipped Cream", 0.15, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping4 = new Topping("chopped peanuts", 0.10, new ArrayList<>(Arrays.asList( "peanuts")));
    ...
    public void setCones(ArrayList<Cone> cones) {this.cones = cones;}
